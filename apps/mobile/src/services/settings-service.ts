...
export const SETTINGS_KEYS = { retentionDays: 'retention_days', notificationsEnabled: 'notifications_enabled', cloudSyncEnabled: 'cloud_sync_enabled', language: 'language' } as const;
